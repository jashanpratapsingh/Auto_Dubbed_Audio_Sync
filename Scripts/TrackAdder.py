...
from Scripts.shared_imports import parseBool
from Scripts.shared_imports import *

def add_audio_tracks_to_video(tracksFolder, videoToProcess, useSoundEffectsTrack=True, effectsTrackFileName="./Scripts/background.mp3", saveMergedTracks=True, defaultLanguage="eng"):
